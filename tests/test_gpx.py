...
class TestLoadAdditionalGpxFiles:
    ...
    def test_load_from_directory(self, temp_dir, sample_gpx_file):
    ...
    def test_load_from_empty_directory(self, temp_dir):
    ...
    def test_load_multiple_tracks_single_file(self, temp_dir):
...
<gpx version="1.1" creator="Test">
    ...
    def test_load_track_with_multiple_segments(self, temp_dir):
...
<gpx version="1.1" creator="Test">
    ...
    def test_skip_empty_segments(self, temp_dir):
...
<gpx version="1.1" creator="Test">
    ...
    def test_skip_invalid_gpx_file(self, temp_dir):
