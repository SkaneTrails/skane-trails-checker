...
class TestSimplifyTrackCoordinates:
    ...
    def test_simplify_returns_endpoints_for_straight_line(self):
    ...
    def test_simplify_handles_short_tracks(self):
...
class TestTrackStatuses:
    ...
    def test_load_track_statuses_existing_file(self, sample_track_status_csv):
    ...
    def test_load_track_statuses_nonexistent_file(self, temp_dir):
    ...
    def test_save_track_statuses(self, temp_dir):
