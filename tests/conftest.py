...
@pytest.fixture
def sample_gpx_file(temp_data_dir):
...
@pytest.fixture
def sample_track_status_csv(temp_data_dir):
...
@pytest.fixture
def sample_foraging_csv(temp_data_dir):
...
@pytest.fixture
def sample_foraging_types_json(temp_data_dir):
