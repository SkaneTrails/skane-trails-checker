...
2. **Your Python version** - Run `python --version`
3. **Your OS** - Windows, Mac, Linux (which distro)
4. **How you're running it** - UV, venv, direct python, etc.
5. **The exact error message** - Copy from terminal or log file
