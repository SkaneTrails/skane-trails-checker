...
if "pytest" not in sys.modules:  # pragma: no cover - Streamlit UI code
    ...
    # Weather Forecast
    st.subheader("🌤️ Weather Forecast for the Next 3 Days")  # pragma: no cover
    weather_data = get_weather()

    if weather_data:  # pragma: no cover - Streamlit UI rendering
        ...
        st.warning("Could not fetch weather data. Please check the API.")  # pragma: no cover
    ...
    # Select random tips
    random_hiking_tip = random.choice(hiking_tips)  # pragma: no cover
    random_quote = random.choice(outdoor_quotes)  # pragma: no cover
    random_foraging_tip = random.choice(foraging_tips)  # pragma: no cover
    random_preservation_tip = random.choice(preservation_tips)  # pragma: no cover
    ...
    with col1:  # pragma: no cover
        st.subheader("💡 Hiking Tip of the Day")  # pragma: no cover
        st.write(f"{random_hiking_tip}")  # pragma: no cover

    # Column 2: Display Outdoor Inspiration
    with col2:  # pragma: no cover
        st.subheader("🌟 Outdoor Inspiration")  # pragma: no cover
        st.write(f"**{random_quote}**")  # pragma: no cover
    ...
    with col1:  # pragma: no cover
        st.subheader("🍄 Foraging Tip of the Day")  # pragma: no cover
        st.write(f"{random_foraging_tip}")  # pragma: no cover

    # Column 2: Display Preservation Tip
    with col2:  # pragma: no cover
        st.subheader("🥒 Preservation Tip of the Day")  # pragma: no cover
        st.write(f"{random_preservation_tip}")  # pragma: no cover
